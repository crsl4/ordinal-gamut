...
The proportional odds model \citep{McCullagh1989} is a subclass of cumulative-logit regression models and it is defined as
\[
...
\]
This is also denoted a \textit{parallelism assumption} on \(\mathbf{\beta}\) \citep{Yee2010}.
...
{\centering \includegraphics{ordinal-gamut_MPE_files/figure-latex/power-plot-1} 
...
\begin{figure}
\centering
\includegraphics{ordinal-gamut_MPE_files/figure-latex/cleft-qq-1.pdf}
...
\begin{figure}
\centering
\includegraphics{ordinal-gamut_MPE_files/figure-latex/cleft-manhattan-1.pdf}
...
{\centering \includegraphics[width=0.75\linewidth]{ordinal-gamut_MPE_files/figure-latex/causalvar-1} 
