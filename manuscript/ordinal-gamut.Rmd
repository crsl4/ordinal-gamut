...
Furthermore, we allow for the study of multiple phenotypes simulatenously by extending GAMuT [@Broadaway2016] to the newly defined categorial response. We denote our proposed methodology "Ordinal GAMuT".
...
To illustrate this procedure, let $Y$ be an ordinal response with $M$ categories, and let $P(Y\leq j)$ be 
