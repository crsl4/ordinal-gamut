...
we defined the person as a control. \missing{For family history, we simulated three different scenarios: 1) parents as family members, 
...
history if family members were affected. \missing{In the Results section, we solely present the results corresponding to the simulations involving parents as family members.}
