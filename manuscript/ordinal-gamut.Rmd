...
GAMuT tests for independence between the phenotype matrix $\mathbf{R}$ (the $N \times 3$ matrix of phenotype residuals) and $\mathbf{G}$ (the $N \times V$ matrix of multivariate 
