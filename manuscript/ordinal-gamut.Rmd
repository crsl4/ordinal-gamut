...
Orofacial clefts: cleft lip (CL), cleft palate (CP), and cleft lip with cleft palate (CLP) 
...
Potential options for enhanced outcome variables include ordinal
categorical variables and conditional means from liability-threshold
models.
